...
int main(int argc, char** argv)
{
  ...
  ros::Publisher imu_yaw_pub = nh.advertise<geometry_msgs::Vector3>("yaw_data", 50);
    ...
    try
    {
      if (ser.isOpen())
      {
        ...
        if(ser.available())
        {
          ...
          input += read;
          while (input.length() >= 59) // while there might be a complete package in input
          {
            //parse for data packets
            data_packet_start = input.find(':');
            if (data_packet_start != std::string::npos)
            {
              ROS_DEBUG("found possible start of data packet at position %d", data_packet_start);
              if ((input.length() >= data_packet_start + 59) && (input.compare(data_packet_start + 57, 2, "\r\n") == 0))  //check if positions 26,27 exist, then test values
              {
                ROS_DEBUG("seems to be a real data package: long enough and found end characters");
                // get quaternion values
                int16_t w = (((0xff &(char)input[data_packet_start + 36]) << 8) | 0xff &(char)input[data_packet_start + 35]);
                int16_t x = (((0xff &(char)input[data_packet_start + 38]) << 8) | 0xff &(char)input[data_packet_start + 37]);
                int16_t y = (((0xff &(char)input[data_packet_start + 40]) << 8) | 0xff &(char)input[data_packet_start + 39]);
                int16_t z = (((0xff &(char)input[data_packet_start + 42]) << 8) | 0xff &(char)input[data_packet_start + 41]);
                ...
                // get gyro values
                int16_t gx = (((0xff &(char)input[data_packet_start + 12]) << 8) | 0xff &(char)input[data_packet_start + 11]);
                int16_t gy = (((0xff &(char)input[data_packet_start + 14]) << 8) | 0xff &(char)input[data_packet_start + 13]);
                int16_t gz = (((0xff &(char)input[data_packet_start + 16]) << 8) | 0xff &(char)input[data_packet_start + 15]);
                ...
                int16_t ax = (((0xff &(char)input[data_packet_start + 18]) << 8) | 0xff &(char)input[data_packet_start + 17]);
                int16_t ay = (((0xff &(char)input[data_packet_start + 20]) << 8) | 0xff &(char)input[data_packet_start + 19]);
                int16_t az = (((0xff &(char)input[data_packet_start + 22]) << 8) | 0xff &(char)input[data_packet_start + 21]);
                ...
                int16_t yaw = (((0xff &(char)input[data_packet_start + 48]) << 8) | 0xff &(char)input[data_packet_start + 47]);
                yaw_data.z = yaw * 0.001;



                uint8_t received_message_number = input[data_packet_start + 5];
                ...
                input.erase(0, data_packet_start + 59); // delete everything up to and including the processed packet
              }
              else
              {
                if (input.length() >= data_packet_start + 59)
                {
